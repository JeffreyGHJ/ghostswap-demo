...
import { MAINNET_CHAINS } from '../../../constants/chains'
...
export default function WalletConnectV2Card({ desiredChainId, setDesiredChainId }) {
  ...
  return (
    <Card
      ...
      provider={provider}
      ENSNames={ENSNames}
      iconSrc={'/images/wallets/wallet-connect2.svg'}
      name={'WalletConnect'}
