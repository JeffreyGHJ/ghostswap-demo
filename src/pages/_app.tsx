  ...
  return (
    <Fragment>
      <Head>
        ...
        />
        <title key="title">GhostSwap</title>

        <meta
          key="description"
          name="description"
          content="Trade, launch, stake, farm, invest, automate, build on the premier DeFi platform of BNBChain"
        />

        <meta name="application-name" content="GhostSwap" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />
        <meta name="apple-mobile-web-app-title" content="GhostSwap" />
        ...
        <meta key="twitter:title" name="twitter:title" content="GhostSwap" />
        <meta key="twitter:url" name="twitter:url" content="https://ghostswap.finance" />
        <meta
        ...
        <meta key="twitter:creator" name="twitter:creator" content="@ghostswapamm" />
        <meta key="og:type" property="og:type" content="website" />
        <meta key="og:site_name" property="og:site_name" content="GhostSwap" />
        <meta key="og:url" property="og:url" content="https://ghostswap.finance" />
